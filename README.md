...
## Features
- 1. Dynamic Announcements & Student Modules  
- 2. Fully Responsive UI (React + Tailwind CSS)  
- 3. Secure authentication & data handling  
- 4. RESTful API integration with MongoDB backend  
